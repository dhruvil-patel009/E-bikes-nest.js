      ...
      <div className="container py-5">
        <div className="row align-items-start">
          ...
          <div className="col-md-5">
            ...
            <p className="mt-3">
              Take to the streets or trails with this powerful all-terrain
              mid-drive electric bicycle. The City Surfer delivers unmatched
              performance you won’t find anywhere else.
            </p>

            <div className="fs-4 fw-bold">
              $1,999 <del className="text-muted fs-6 ms-2">$2,300</del>
            </div>

            <div className="bg-light p-3 rounded mt-3">
              <label className="fw-semibold">
                Color: <span className="text-capitalize">{selectedColor}</span>
              </label>
